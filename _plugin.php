...
register_activation_hook( __FILE__, 'taxonomytaxi\electric_boogaloo\activate' );
register_deactivation_hook( __FILE__, 'taxonomytaxi\electric_boogaloo\deactivate' );
